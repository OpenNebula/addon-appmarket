...
After adding the dependencies to the main.js file, new minfied files including the appmarket tabs can be generated by running the *grunt requirejs* command. For more details on how to compile and include new tabs to Sunstone, check [the official development guide](http://docs.opennebula.org/stable/integration/references/sunstone_dev.html#adding-custom-tabs).
